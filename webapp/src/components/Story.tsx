    ...
    <section ref={ref} id="story" className="story">
      <div className="story-copy">
        ...
        <div className="story-points">
          <div className="point"><b>1</b><div><strong>False positives ruin reputations</strong><div style={{ color: "#5A5F7A", fontSize: 13, marginTop: 4, lineHeight: 1.5 }}>Students, researchers, and teams get flagged for writing that is genuinely theirs.</div></div></div>
          <div className="point"><b>2</b><div><strong>Detectors keep getting sharper</strong><div style={{ color: "#5A5F7A", fontSize: 13, marginTop: 4, lineHeight: 1.5 }}>Unicode, statistical, metadata, and spatial models — each watching a different fingerprint.</div></div></div>
          <div className="point"><b>3</b><div><strong>Aphanis makes the invisible visible</strong><div style={{ color: "#5A5F7A", fontSize: 13, marginTop: 4, lineHeight: 1.5 }}>Audit first, understand the signals, then sanitize with control — not blind paraphrasing.</div></div></div>
        </div>
      </div>
      <div className="reveal">
        ...
        <div style={{ position: "relative", display: "grid", gap: 12 }}>
          <div className="reveal-card">
            <h4>Raw input — what detectors see</h4>
            <div style={{ marginTop: 10, fontFamily: "var(--mono)", fontSize: 12.5, lineHeight: 1.7, color: "#D6DAE8" }}>
          ...
          <div className="reveal-card">
            <h4>After Aphanis — paranoid mode</h4>
            <div style={{ marginTop: 10, fontFamily: "var(--mono)", fontSize: 12.5, lineHeight: 1.7, color: "#D6DAE8" }}>
