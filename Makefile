...
## Build the React frontend into aphanis/dashboard_static
build-dashboard:
 cd webapp && npm ci && npm run build
 @echo "✅ Dashboard built into aphanis/dashboard_static/"

clean:
 rm -rf dist/ build/ *.spec .eggs/ aphanis.egg-info/ aphanis/dashboard_static/
