...
# ---- Download binary ----
echo "⬇ Downloading Aphanis standalone binary..."
...
if [ ! -f "$DOWNLOAD_PATH" ]; then
 echo "⚠ GitHub release not found, trying local build..."
 ...
 echo "⚠ No binary available. Installing via pip (requires Python)..."
...
echo ""
echo "🛡 Em-dashes, zero-width chars, AI clichés, and metadata are"
